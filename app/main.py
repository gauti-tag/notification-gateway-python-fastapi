...
class NotificationRequest(BaseModel):
    ...
    currency: str
    paid_transaction_amount: str
    paid_currency: str
    change_rate: float
    conflictual_transaction_amount: str
    conflictual_currency: str
    wallet: str
    phone_number: Union[str, None] = None
    momo_reference_id: Union[str, None] = None
    wallet_alias: str
    wallet_name: str
    receipt_generator_url: str
    cancellation: bool
...
async def root(request: NotificationRequest, background_tasks: BackgroundTasks):
